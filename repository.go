...
type Repository interface {
	...
	CreateUserKey(ctx context.Context, publicKey, ephemeralPublicKey, address, deviceId string, expiresAtSecs int64) (*UserKey, error)
...
type PermissionsRepository interface {
	GetPermissions(ctx context.Context, address string) (*UserPermissions, error)
}
